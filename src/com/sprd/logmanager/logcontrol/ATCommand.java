...
public interface ATCommand {
    ...
    String ENG_AT_SET_SPPCMDUMP = "AT+SPPCMDUMP=";
    ...
    /*
     * BEGIN BUG540993 2016/05/11 sprd:EngineerMode add the parameter of CAP log
     * packet length feature
     */
    String ENG_AT_GETCAPLOGLENGTH = "AT+SPCAPLEN?";
    String ENG_AT_SETCAPLOGLENGTH = "AT+SPCAPLEN=";
    /*
     * END BUG540993 2016/05/11 sprd:EngineerMode add the parameter of CAP log
     * packet length feature
     */
    ...
    String ENG_AT_SET_VAMOS = "at+spengmd = 1,0,7,7,";
    ...
    String ENG_AT_GET_EVS = "AT+SPENGMDVOLTE=12,0,1";// Voice codec
                                                     // type---1<value>: Bit 0:
                                                     // amr-wb; Bit 1: amr-nb;
                                                     // Bit 2: EVS
